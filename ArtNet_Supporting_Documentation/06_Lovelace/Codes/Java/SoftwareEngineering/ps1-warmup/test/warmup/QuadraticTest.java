...
public class QuadraticTest {
    ...
    // covers a=0, b>0, c>0
    @Test
    public void testZero_a() {
        assertEquals(makeSet(-2), Quadratic.roots(0, 1, 2));
    }
    
    // covers a=0, b=0, c=0
    @Test
    public void testZero_aZer_bZero_c() {
        assertEquals(makeSet(), Quadratic.roots(0, 0, 0));
    }
    
    // covers a=0, b=0, c>1
    @Test
    public void testZero_aZero_b() {
        assertEquals(makeSet(2), Quadratic.roots(0, 0, 2));
    }
    
    // covers a=0, b>0, c=0
    @Test
    public void testZero_aZero_c() {
        assertEquals(makeSet(0), Quadratic.roots(0, 2, 0));
    }
    ...
    public void testRealRoots() {
        assertEquals(makeSet(-1, -2), Quadratic.roots(1, 3, 2));
    }
