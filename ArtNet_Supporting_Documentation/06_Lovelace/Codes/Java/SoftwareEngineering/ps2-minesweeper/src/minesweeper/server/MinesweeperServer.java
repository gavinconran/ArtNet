 ...
 */
public class MinesweeperServer extends JFrame {
 ...
 // set up server and GUI that displays messages
    public MinesweeperServer(boolean debug, List<Integer> params) {
 ...
 // private inner class Player manages each Player as a runnable
            ...
            throws IOException
    {
        ...
        // start server
        MinesweeperServer server = new MinesweeperServer(debug, params);
    ...
    public static void main(String[] args) {
        ...
        boolean debug = false;
        File file = null;
        Integer size = 3; //10; // Default size.
        try {
