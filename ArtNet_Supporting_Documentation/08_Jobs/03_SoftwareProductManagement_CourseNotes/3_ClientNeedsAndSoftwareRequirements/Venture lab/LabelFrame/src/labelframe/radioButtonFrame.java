...
public class radioButtonFrame extends JFrame {
    ...
    private Font boldItalicFont; // font fot bold and italic text
    private JRadioButton plainJRadioButton; // selects plain text
    private JRadioButton boldJRadioButton; // selects italic text
    ...
    public radioButtonFrame() {
        ...
        add( italicJRadioButton ); // add plain button to JFrame
        add( boldItalicJRadioButton ); // add bold button to JFrame
